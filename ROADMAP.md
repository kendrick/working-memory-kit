...
- **Retire scaffold-prompt.md.** The installer is the canonical, tested setup path; the standalone prompt duplicated template content and kept drifting, so it's removed rather than resynced. · issue: #7
